...
class Buku_model extends CI_Model
 {
	...
	public function get_jml_peminjaman($first_date, $second_date) {
		try {
			// Validasi tanggal
			$this->someFunction($first_date);
			$this->someFunction($second_date);
			...
			// Mengembalikan array kosong jika terjadi kesalahan validasi tanggal
			log_message('error', 'Error dalam get_jml_peminjaman: ' . $e->getMessage());
			return array();
		}
	}

	public function someFunction($date) {
