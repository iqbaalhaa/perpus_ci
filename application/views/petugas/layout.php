  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php echo base_url(); ?>petugas/Home" class="logo">
        ...
        <span class="logo-lg"><b>PERPUS</b>MTsN5</span>
      </a>
      ...
      <section class="sidebar">
        ...
        <center>
          <a href="<?php echo base_url(); ?>petugas/Home">
            <img src="<?php echo base_url(); ?>assets2/img/logomts.png" alt="" srcset="" width="47px">
          </a>
        </center>
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; 2019 <a href="www.smarak.net">MTsN 5 Kerinci</a>.</strong> All rights reserved.
    </footer>
