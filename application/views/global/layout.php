...
<body>
    ...
    <nav class="teal darken-2">
      <div class="container">
        ...
        <div class="nav-wrapper">
          <a href="<?php echo base_url(); ?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/logomts.png" width="60px" alt=""></a>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="200px" src="<?php echo base_url(); ?>assets2/img/logomts.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-2 z-depth-5">PERPUSTAKAAN MTsN 5 Kerinci</h3>
  ...
  <footer class="teal darken-2">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ICT &copy; : <a href="#" target="_blank">MTsN 5 Kerinci</a>
        </div>
